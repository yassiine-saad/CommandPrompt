/*
Fichier cmd.h : ce fichier contient les fonctions d'exécution des commandes externes, d'initialisation et de parsing des cmd_t
Auteur : SAAD Yassine
Dépendances : stdlib.h stdio.h sys/types.h fcntl.h
*/
